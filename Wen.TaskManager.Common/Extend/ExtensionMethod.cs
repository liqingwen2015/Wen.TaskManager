...
namespace Wen.Helpers.Common.Extend
{
    ...
    public static class ExtendUtil
    {
        ...
        /// <summary>
        /// 用指定的 string 对象来与自身进行比较，判断是否具有相同值（忽略大小写、默认 Trim()）
        /// </summary>
        /// <param name="a"> 要比较的字符串 </param>
        /// <param name="b"> 待比较的字符串 </param>
        /// <param name="isTrim">是否需要 Trim</param>
        /// <returns></returns>
        public static bool IsEqual(this string a, string b, bool isTrim = true)
        {
            return isTrim ? string.Equals(a.Trim(), b.Trim(), StringComparison.OrdinalIgnoreCase) : string.Equals(a, b, StringComparison.OrdinalIgnoreCase);
        }
